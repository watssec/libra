...
#define PTHREAD_ONCE_INIT                                                      \
  { PTHREAD_NEEDS_INIT, PTHREAD_MUTEX_INITIALIZER }
...
int pthread_getprio(pthread_t) { return 0; }
int pthread_setprio(pthread_t, int) { return 0; }
void pthread_yield(void) {}

int pthread_mutexattr_getprioceiling(pthread_mutexattr_t *, int *) { return 0; }
int pthread_mutexattr_setprioceiling(pthread_mutexattr_t *, int) { return 0; }
int pthread_mutex_getprioceiling(pthread_mutex_t *, int *) { return 0; }
int pthread_mutex_setprioceiling(pthread_mutex_t *, int, int *) { return 0; }

int pthread_mutexattr_getprotocol(pthread_mutexattr_t *, int *) { return 0; }
...
int pthread_spin_init(pthread_spinlock_t *, int) { return 0; }
int pthread_spin_destroy(pthread_spinlock_t *) { return 0; }
int pthread_spin_trylock(pthread_spinlock_t *) { return 0; }
int pthread_spin_lock(pthread_spinlock_t *) { return 0; }
int pthread_spin_unlock(pthread_spinlock_t *) { return 0; }
int pthread_getcpuclockid(pthread_t, clockid_t *) { return 0; }
